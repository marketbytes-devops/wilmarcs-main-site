...
export default function Header() {
  ...
  return (
    <header className={`header fixed top-0 bg-gradient-to-b from-black/80 to-transparent w-full left-0 z-[60] ease duration-200 ${isOpen?'':'menuopen'}`}>
        <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-12">
              ...
              <ul className="flex items-center md:gap-12 sm:gap-8 gap-6 relative z-[70]">
