        ...
        <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-12">
              <ul className="flex items-center gap-12 mainmenu">
                <li className={`header-link ${pathname.startsWith('/about') ? 'font-bold' : ''} all-ease lg:py-6 py-2.5`}><a href={`${BASE_URL}about-us`}>About us</a></li>
                <li className={`header-link ${pathname.startsWith('/services') ? 'font-bold' : ''} all-ease lg:py-6 py-2.5`} onMouseEnter={() => setShowServicesMenu(true)} onMouseLeave={() => setShowServicesMenu(false)}>
                  <a href={`${BASE_URL}services`} className={`flex items-center gap-2 ${showServicesMenu ? 'hover:font-semibold' : ''} all-ease min-w-[90px]`}>
                    <span>Services</span> 
                      ...
                      <div className="grid grid-cols-4 gap-6">
                        ...
                        <div className={`transition-all ease-in-out duration-500 ${showServicesMenu ? 'top-0 opacity-100' : 'opacity-0 relative top-16'}`}>
                          ...
                          <ul className="grid gap-5 text-white font-medium text-2xl footul">
                            <li><a href={`${BASE_URL}services#live`}>Live‑Action Production</a></li>
                            <li><a href={`${BASE_URL}services#animation`}>Animation & Motion</a></li>
                            <li><a href={`${BASE_URL}services#social`}>Social & Performance</a></li>
                          </ul>
                        </div>
                        <div className={`transition-all ease-in-out duration-500 ${showServicesMenu ? 'top-0 opacity-100' : 'opacity-0 relative top-16'}`}>
                          <ul className="grid pt-14 gap-5 text-white font-medium text-2xl footul">
                            ...
                            <li><a href={`${BASE_URL}services#post`}>Post‑Production Studio</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <li className={`header-link ${pathname.startsWith('/portfolio') ? 'font-bold' : ''} all-ease lg:py-6 py-2.5`}><a href={`${BASE_URL}portfolio`}>Portfolio</a></li>
                <li className={`header-link ${pathname.startsWith('/industries') ? 'font-bold' : ''} all-ease lg:py-6 py-2.5`}><a href={`${BASE_URL}industries`}>Industries</a></li>
                <li className={`header-link ${pathname.startsWith('/contact') ? 'font-bold' : ''} all-ease lg:py-6 py-2.5`}><a href={`${BASE_URL}contact`}>Contact</a></li>
              </ul>
