  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-4 gap-x-6 gap-y-12 pb-8">
            ...
            <div>
              ...
              <ul className="grid gap-4 footul text-sm">
                <li><a className={pathname.startsWith('/industries/travel-hospitality') ? '' : ''} href={`${BASE_URL}industries/travel-hospitality`}>Travel & Hospitality</a></li>
                <li><a className={pathname.startsWith('/industries/tech-saas') ? '' : ''} href={`${BASE_URL}industries/tech-saas`}>Tech / SaaS</a></li>
                <li><a className={pathname.startsWith('/industries/real-estate') ? '' : ''} href={`${BASE_URL}industries/real-estate`}>Real Estate</a></li>
                <li><a className={pathname.startsWith('/industries/post-production') ? '' : ''} href={`${BASE_URL}industries/post-production`}>Post-Production</a></li>
                <li><a className={pathname.startsWith('/industries/csr-video') ? '' : ''} href={`${BASE_URL}industries/csr-video`}>CSR Video</a></li>
                <li><a className={pathname.startsWith('/industries/media-entertainment') ? '' : ''} href={`${BASE_URL}industries/media-entertainment`}>Media & Entertainment</a></li>
                <li><a className={pathname.startsWith('/industries/manufacturing') ? '' : ''} href={`${BASE_URL}industries/manufacturing`}>Manufacturing</a></li>
                <li><a className={pathname.startsWith('/industries/healthcare') ? '' : ''} href={`${BASE_URL}industries/healthcare`}>Healthcare</a></li>
                <li><a className={pathname.startsWith('/industries/fintech') ? '' : ''} href={`${BASE_URL}industries/fintech`}>FinTech</a></li>
                <li><a className={pathname.startsWith('/industries/education') ? '' : ''} href={`${BASE_URL}industries/education`}>Education</a></li>
                <li><a className={pathname.startsWith('/industries/e-commerce') ? '' : ''} href={`${BASE_URL}industries/e-commerce`}>E-Commerce</a></li>
              </ul>
            </div>
            <div>
      ...
      <div className="bg-black fixed z-10 left-0 bottom-0 w-full py-2 px-4 lg:hidden flex items-center justify-between gap-2">
        ...
        <a href={`${BASE_URL}about-us`} className="flex flex-col gap-1 items-center justify-center">
        ...
        <a href={`${BASE_URL}services`} className="flex flex-col gap-1 items-center justify-center">
        ...
        <a href={`${BASE_URL}portfolio`} className="flex flex-col gap-1 items-center justify-center">
        ...
        <a href={`${BASE_URL}industries`} className="flex flex-col gap-1 items-center justify-center">
        ...
        <a href={`${BASE_URL}contact`} className="flex flex-col gap-1 items-center justify-center">
